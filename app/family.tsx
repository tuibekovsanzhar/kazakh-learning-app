...
export default function FamilyScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.subtitle}>{familyWords.length} {t('words')}</Text>

      <View style={styles.practiceRow}>
        <TouchableOpacity
          style={styles.flashcardsBtn}
          onPress={() => router.push({ pathname: '/flashcards' as any, params: { deck: 'family', title: t('family'), from: '/family' } })}
        >
          <Text style={styles.flashcardsBtnText}>🃏 {t('flashcards')}</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.quizBtn}
          onPress={() => router.push({ pathname: '/quiz' as any, params: { deck: 'family', title: t('family'), from: '/family' } })}
        >
